...
if ( is_ajax() ) {
	...
	$EPpaytId			= $EParrayResponse['transactions']['0']['related_resources']['0']['sale']['id']; // Since 1.2.0
	...
	if ( $pp_remembered_cards and $wh_remembered_cards and $pp_remembered_cards !== $wh_remembered_cardsand ) {
		try {
